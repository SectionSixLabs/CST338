...
class EndingListener implements ActionListener
{
   ...
   public void actionPerformed(ActionEvent e)
   {
      ...
      else
      {
         ...
         updateScore();
         Assignment6.numTurns += 1;
         if(Assignment6.numTurns == Assignment6.NUM_CARDS_PER_HAND)
         {
            EndGame();
         }
      }
   ...
   private void updateScore()
   {
      ...
      if(humRank > pcRank)
      {
         Assignment6.scoreHum += 1;
      }
      else if (humRank < pcRank)
      {
         Assignment6.scorePC += 1;
      }
      else 
      {
         //Do update to score
      ...
      JLabel compScore = 
          new JLabel("CPU: "+Assignment6.scorePC, SwingConstants.CENTER);
      JLabel humScore = 
          new JLabel("Player: "+Assignment6.scoreHum+"", SwingConstants.CENTER);
   ...
   private void pcTurn2(int cardIndex) {
      ...
      if(Assignment6.playNum == 0)
      {
         myCardTable.pnlPlayArea.add(computerFaces[cardIndex]);
         myCardTable.pnlPlayArea.remove(computerLabels[cardIndex]);
         Assignment6.oldIndex = cardIndex;
      }
      else if(Assignment6.playNum > 0)
      {
         myCardTable.pnlPlayArea.remove(computerFaces[Assignment6.oldIndex]);
   ...
   private void EndGame()
   {
      ...
      String messageText = "";
      if(Assignment6.scoreHum > Assignment6.scorePC)
      {
         messageText = "You win!";
      }
      else if(Assignment6.scoreHum < Assignment6.scorePC)
      {
